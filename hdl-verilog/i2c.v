...
/* Module Version: 1.2 */
/* /usr/local/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n i2c -lang verilog -synth lse -bus_exp 7 -bb -type efb -arch xo2c00 -freq 133 -i2c1 -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_addr 7 -wb -dev 7000  */
/* Sun May  1 17:36:29 2016 */


`timescale 1 ns / 1 ps
module i2c (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    defparam EFBInst_0.I2C1_CLK_DIVIDER = 84 ;
    ...
    defparam EFBInst_0.EFB_WB_CLK_FREQ = "133.0" ;
