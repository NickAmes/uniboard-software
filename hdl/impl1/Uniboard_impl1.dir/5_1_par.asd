...
GLOBAL_SECONDARY_0_LOADNUM = 56;
GLOBAL_SECONDARY_0_SIGTYPE = CE+RST;
; Global secondary clock #1
GLOBAL_SECONDARY_1_SIGNALNAME = G_299;
...
GLOBAL_SECONDARY_3_SIGNALNAME = protocol_interface/databus_out[0]_1_sqmuxa;
GLOBAL_SECONDARY_3_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_3_LOADNUM = 16;
GLOBAL_SECONDARY_3_SIGTYPE = CE;
; Global secondary clock #4
GLOBAL_SECONDARY_4_SIGNALNAME = protocol_interface/uart_input/baud_reset;
