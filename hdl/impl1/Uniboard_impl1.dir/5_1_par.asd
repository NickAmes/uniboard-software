...
GLOBAL_PRIMARY_0_LOADNUM = 373;
; Global primary clock #1
GLOBAL_PRIMARY_1_SIGNALNAME = arm_select_0_;
...
GLOBAL_SECONDARY_0_LOADNUM = 58;
GLOBAL_SECONDARY_0_SIGTYPE = CE+RST;
; Global secondary clock #1
GLOBAL_SECONDARY_1_SIGNALNAME = G_489;
GLOBAL_SECONDARY_1_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_1_LOADNUM = 77;
